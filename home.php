...
<html>
	...
	<body style="display:flex;flex-direction:column;">
		...
		<div class="magic">
    <form class="newpost" action="add.php" method="POST"  enctype="multipart/form-data">
			  <p class="postBut"><i class="fa fa-plus" id="side"></i>New Post</p>
        <div class="formcont">
        <textarea name="details" maxlength="500" required="required"></textarea><br/>
			  <div class="pubsel"><p style="display:inline;margin:left:94pt;">public</p> <input type="checkbox" name="public[]" value="yes"/></div><br/>
   ...
   <a class="groupbutt" href="groups.php"><i id="side" style="margin-top:5pt;"class="fa fa-group"></i>Groups</a>
   </div>
		<div class="posts" style="display: flex; flex-grow: 2;background:url('content/loading.gif') no-repeat center var(--background-colour); background-size: 10%;">
			<iframe src="getfeed.php" style="width:100%; height:100%;" frameborder="0" sandbox="allow-top-navigation allow-same-origin allow-scripts allow-popups allow-forms"></iframe>
		</div>
